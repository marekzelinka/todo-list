...
export default function ProfileMenu() {
  ...
  return (
    <details ref={detailsRef} className="group relative cursor-pointer">
      ...
      <div
        role="menu"
        className="absolute top-full right-0 z-50 mt-2 min-w-max overflow-hidden rounded-3xl border border-gray-200 bg-gray-50 py-1 text-sm font-semibold ring-1 shadow-lg ring-slate-900/10 dark:border-gray-700 dark:bg-gray-900 dark:ring-0"
